    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form class="shadow p-4">
                <div class="mb-3">
                    <label for="cat_name">Sub Category Name</label><span style='color:red' ;> * </span><?php if (!empty($errmsg1)) {
                                                                                                            echo $errmsg1;
                                                                                                        } ?>
                ...
                <div class="mb-3">
                    <label for="cat_details">Sub Category code</label><span style='color:red' ;> * </span>
                ...
                <div class="mb-3">
                    <label for="cat_details">Sub Category details</label><span style='color:red' ;> * </span>
                    <input type="text" value="<?php if (!empty($cat_code)) {
                                                    echo $cat_code;
                                                } ?>" class="form-control" name="sub_cat_details" id="sub_cat_details" placeholder="sub category details">
                    <span id="emptydetails" style="color:red;"></span>
                </div>

                <div class="mb-3">
                    <span id="msg" style="display: none;">Data Successfully Inserted</span>
                    <button type="button" class="btn btn-primary" onclick="DataInsertj()">Add Sub Category</button>
                </div>
