...
//  if($_SERVER["REQUEST_METHOD"]=="POST"){
    $id = $_GET["id"];
     ...
     $sqle = "SELECT * FROM sub_category WHERE id=$id" ;
   ...
   if($execute1->num_rows>0){
      $exist="<span style='color:red; size:20px'>Try another code</span>";
       ...
       $sql = "UPDATE sub_category SET sub_cat_name='$cat_name',sub_cat_code='$cat_code',sub_cat_details='$sub_cat_details'  WHERE id='$id'";
